...
| **ETL Pipeline on AWS Glue** | Built an ETL Pipeline using AWS Glue to extract, transform and load the data (end to end) | AWS | [View Repo](https://github.com/zorrrooo/ETL-Pipeline-AWS-Glue-) |
