...
<ul>
  <li><strong>Financial Analyst</strong> with experience in <strong>FP&amp;A, financial planning, budgeting, forecasting, variance analysis, and financial reporting</strong></li>
  <li>Experienced in <strong>financial operations, month-end reporting, income statement analysis, and data-driven decision-making</strong></li>
  <li>Skilled in <strong>Excel, Power BI, SQL, Python, Workday, Cognos, and PeopleSoft</strong> for financial analysis and reporting</li>
  <li>Passionate about <strong>FP&amp;A, Corporate Finance, Financial Modeling, and business performance analysis</strong></li>
  <li>Focused on transforming <strong>financial and operational data into actionable insights</strong> that support strategic planning and business decisions</li>
</ul>
...
| **Exploratory Data Analysis in Python** | Data cleaning, analysis, visualization and reporting to detect credit card fraud using EDA | Python | [View Repo](https://github.com/zorrrooo/Exploratory-Data-Analysis_for_Credit-Card-Fraud-Detection/tree/main) |
...
| **ETL Pipeline** | Built an ETL pipeline using AWS Glue to extract, transform, and load data end-to-end | AWS | [View Repo](https://github.com/zorrrooo/ETL-Pipeline-AWS-Glue-) |
| **Data Transformation in Power BI** | Used DAX command & built-in features to transform and manipulate data in Power BI by computing, merging, cleaning, splitting and modeling the data | Power BI | [View Repo](https://github.com/zorrrooo/Data-Transformation-in-Power-BI) |
...
## 📈 GitHub Stats
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=zorrrooo&theme=default" height="165" />
  <img src="https://github-readme-stats.vercel.app/api?username=zorrrooo&show_icons=true&hide_border=false&count_private=true" height="165" />
</p>
...
<p>
  <a href="https://linkedin.com/in/m-z-s">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:">
    <img src="https://img.shields.io/badge/Email-DB4437?logo=gmail&logoColor=white" />
  </a>
  <a href="https://github.com/zorrrooo">
